...
mix.copyDirectory('resources/js/scripts/maps/theme', 'public/js/scripts/maps/theme')
...
mix
    ...
    .sass('resources/sass/custom_icons_menu.scss', 'public/css').options({ processCssUrls: false })
    ...
    .js('resources/js/scripts/maps/map.js', 'public/js')
