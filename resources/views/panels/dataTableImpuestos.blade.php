                    ...
                    return (
                        '<div class="d-inline-flex dropright">' +
                            ...
                            '<div class="dropdown-menu dropdown-menu-right justify-content-center navbar-shadow">' +
                                '<a href="' + aUrl + '/edit/' + full[3] + '" class="dropdown-item">' +
                                feather.icons['edit'].toSvg({
                                    class: 'font-small-4 mr-50'
                                }) + (typeof MB === 'undefined' ? 'Editar' : 'Ver') +
                                '</a>' +
                                (typeof MB === 'undefined' ? '<a href="' + aUrl + '/delete/' + full[3] + '" class="dropdown-item">' +
